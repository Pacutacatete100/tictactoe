...
def draw_big_grid():
    pygame.draw.line(background, (0, 0, 0), (300, 20), (300, 880), 4)
    pygame.draw.line(background, (0, 0, 0), (600, 20), (600, 880), 4)

    # horizontal lines...
    pygame.draw.line(background, (0, 0, 0), (20, 300), (880, 300), 4)
    pygame.draw.line(background, (0, 0, 0), (20, 600), (880, 600), 4)

def draw_small_grid():

    # horizontal line for small grid
    pygame.draw.line(background, (0, 0, 0), (20, 100), (280, 100), 4)
    pygame.draw.line(background, (0, 0, 0), (20, 200), (280, 200), 4)

    #vertical line for small grid
    pygame.draw.line(background, (0, 0, 0), (100, 20), (100, 280), 4)
    pygame.draw.line(background, (0, 0, 0), (200, 20), (200, 280), 4)

    """"
    -TODO:
        -make way to call this method in each big square instead of drawing it each time
            *maybe instead of set numbers use variables to represent certain positions on the big board
    """
...
def showBoard(window_size, board):
