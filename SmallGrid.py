...
class SmallGrid:
    ...
    def __init__(self, start_X_horizontal_line_1, start_Y_horizontal_line_1, end_X_horizontal_line_1, end_Y_horizontal_line_1,
                 ...
                 start_X_vertical_line_2, start_Y_vertical_line_2, end_X_vertical_line_2, end_Y_vertical_line_2, background):
    ...
    def draw_small_grid(self, background):
        ...
        middle_left_rect = pygame.Rect(mlr)
        ...
        middle_right_rect = pygame.Rect(mrr)
        ...
        bottom_left_rect = pygame.Rect(blr)
        ...
        bottom_middle_rect = pygame.Rect(bmr)
        ...
        bottom_right_rect = pygame.Rect(brr)
